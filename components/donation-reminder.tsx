  ...
  return (
    <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
      ...
      <p className="text-sm mb-3">
        ...
        Please consider supporting us through our Buy Me a Coffee page. A simple donation of €3 goes a long way in keeping these tools running for everyone.
      </p>
      <Link
